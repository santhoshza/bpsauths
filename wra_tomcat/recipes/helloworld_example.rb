...
tomcat_install 'helloworld' do
  ...
  #tarball_uri 'file://C:/Users/Ash143San/chef-practice/chef-repo/apache-tomcat-8.0.47.tar.gz'
...
remote_file '/opt/tomcat_helloworld/webapps/sample.war' do
  ...
  #source 'file:///C:/users/Ash143San/chef-practice/chef-repo/sample.war'
